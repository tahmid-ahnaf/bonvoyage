...
//     variables.levelOneVars.characterDeltatime = (variables.levelOneVars.characterCurrentime - variables.levelOneVars.characterPrevtime) / 10.0f;
...
//         variables.AnimationSpeed.levelOneWindow.sky -= 1;
//         if (variables.AnimationSpeed.levelOneWindow.sky < -levelOneWindow.sky.rect.w)
//         {
//             variables.AnimationSpeed.levelOneWindow.sky = 0.0;
//         }
...
//         {
//             variables.AnimationSpeed.levelOneWindow.mountains = 0.0;
//         }
...
//         {
//             variables.AnimationSpeed.levelOneWindow.treeshade = 0.0;
//         }
...
//         {
//             variables.AnimationSpeed.levelOneWindow.trees = 0.0;
//         }

//         variables.AnimationSpeed.levelOneWindow.track -= 7;
//         if (variables.AnimationSpeed.levelOneWindow.track < -levelOneWindow.track.rect.w)
//         {
//             variables.AnimationSpeed.levelOneWindow.track = 0.0;
//         }
//     }
...
void updateAnimationSpeedForLevelOneWindow()
{
    ...
    levelOneWindow.characterFramePosition.rect.x = 500;
...
void drawLevelOneWindowFunction()
{
    ...
    SDL_RenderCopy(app.rend, levelOneWindow.moon.tex, NULL, &levelOneWindow.moon.rect);
