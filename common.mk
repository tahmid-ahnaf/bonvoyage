...
_OBJS += drawLevelOneGameOver.o drawScoreBoard.o drawLevelOnePlayerName.o drawLife.o drawLevelOneCompleted.o variablesLevelOne.o variablesLevelTwo.o resetAll.o loadScoreFile.o drawWelcomeWindow.o drawNewgameWindow.o drawCoins.o  drawObstacle.o drawLevelTwoWindow.o   drawLevelOneWindow.o updateScore.o updatePlayerName.o draw.o  collisionLevelOne.o collisionLevelTwo.o drawCoinsEffect.o drawLifeLoss.o drawlevelTwoTracks.o drawLevelTwoCoins.o drawLevelTwoBombandPlane.o drawLevelTwoLife.o
